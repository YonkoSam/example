      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Congrats {{ $job ->employer->name }}! Your job is now live on our website.</span>
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  ...
                  <p> Your job is now live on our website.</p>
                  <p> Job Title : {{ $job ->title  }} pays {{ number_format($job->salary ) }} $ </p>
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td> <a href="{{ url('/jobs/'.$job->id) }}" target="_blank">View Your Job Listing</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
