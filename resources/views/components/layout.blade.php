...
<div>
    @if (request()->is('jobs') || request()->is('jobs*'))
           ...
           <x-button href="/jobs/list/{{ Auth::user()->employer->id }}">My Jobs Listings</x-button>
           @can('create','App\\Models\Job')
           <x-button href="/jobs/create">Create Job</x-button>
            @endcan
           @endif
    @if (request()->is('posts') || request()->is('posts*'))
    <x-button href="/posts/list">My Posts</x-button>
    ...
    <main>
        <div {{ $attributes }} class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            {{ $slot }}
        </div>
    </main>
</div>
